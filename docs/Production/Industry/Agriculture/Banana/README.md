...
> What is the technique, transformation logic, and system of constraints?
...
* **Value-Creation Flow:**
  Biological growth → Harvest → Post-harvest conditioning → Logistics → Market (fresh or processed)
